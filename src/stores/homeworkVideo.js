const HOMEWORK_VIDEOS = [
    {
        id: 1,
        title: "JavaScript Kirish - O'zgaruvchilar va Ma'lumot turlari",
    ...
    {
        id: 2,
        title: "Array Metodlari - Map, Filter, Reduce",
    ...
    {
        id: 3,
        title: "Vue.js 3 Asoslari - Composition API",
    ...
    {
        id: 4,
        title: "Python Dasturlash - Funktsiyalar",
    ...
    {
        id: 5,
        title: "UI/UX Dizayn - Figma Asoslari",
...
export default HOMEWORK_VIDEOS;
